...
ActiveRecord::Schema.define(version: 20_170_421_170_508) do
  create_table 'wojxorfgax_items', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.text     'audio_description',  limit: 65_535
    t.text     'audio_hosts',        limit: 65_535
    ...
    t.index %w[wojxorfgax_user_id audio_identifier], name: 'index_wojxorfgax_items_on_user_id_and_audio_identifier', unique: true, using: :btree
